...
class RedirectModel extends Object {
	...
	public static function hit($oldurl){
		dibi::query('UPDATE redirect SET hits=hits+1 WHERE %s',$oldurl,' LIKE oldurl LIMIT 1');
	}
	
	public static function getByOldUrl($oldurl){
		return dibi::fetchSingle("SELECT newurl FROM redirect WHERE %s",$oldurl," LIKE oldurl");
	}
